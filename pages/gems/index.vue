  ...
  <main class="py-8 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-prose">
      <div class="border-y sm:border border-slate-300 dark:border-zinc-700 shadow sm:rounded-2xl py-3 px-4 bg-yellow-50 dark:bg-zinc-800 dark:text-zinc-50">
        <div v-if="gem.text === 'Іспит'">Іспит, повторіть всі перлини з <NuxtLink :to="'/gems/' + gem.quarter" class="underline decoration-1 underline-offset-2">кварталу {{ gem.quarter }}</NuxtLink></div>
        <div v-else v-html="gem.text"></div>
