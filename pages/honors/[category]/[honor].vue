...
<template>
  ...
  <main class="py-8 px-4 sm:px-6 lg:px-8 bg-white dark:bg-stone-800">
    <div id="honor-heading" class="absolute pt-24 pb-4 top-0 right-0 left-0 px-4 sm:px-0" :class="honor.background">
    ...
    <div class="mx-auto max-w-prose mt-80 sm:mt-44">
