...
<template>
  <header class="bg-slate-800 text-slate-50 fixed top-0 left-0 right-0 duration-500 transition-spacing" :class="!y ? 'py-4' : 'py-2' ">
    <div class="px-6 lg:px-8 flex items-center gap-6">
      <NuxtLink to="/">
